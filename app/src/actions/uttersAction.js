...
export const successAction =
    (message) => { return {type : "SUCESS_ACTION_UTTER", text : message};};
...
const setUtterTextAction =
    (utter_position, text_position, text) => {
      return {
        type : "SET_UTTER_TEXT",
        text : text,
...
export const isEnableUtterButton =
    (current_utter) => {
...
const checkNonEmptyFields =
    (current_utter) => {
      ...
      current_utter.utters.forEach(utter => {utter.utterText.forEach(text => {
...
export const setUtterText =
    (utter_position, text_position, text, current_utter) => {
      return async(dispatch) => {
